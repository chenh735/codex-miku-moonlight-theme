...
- 为“Codex 初音未来主题”桌面和开始菜单快捷方式增加青绿色 Miku 音乐字标；图标以 16、20、24、32、48、64、128 和 256 像素多尺寸 ICO 随受管运行时安装，适合固定到 Windows 任务栏。
- 增加无第三方依赖的 PowerShell 图标生成脚本和 PNG/ICO 二进制契约测试，重新打包时可确定性重建资源。
